    <!-- Main navbar -->
    <div class="navbar navbar-dark navbar-expand-lg navbar-static border-bottom border-bottom-white border-opacity-10" style="background-color: #003DA5;">
        <div class="container-fluid">
            ...
            <div class="navbar-brand flex-1 flex-lg-0">
                <a href="/" class="d-inline-flex align-items-center">
                    <img src="{{URL::asset('assets/images/ucaa-logo.png')}}" alt="UCAA" style="height: 32px;" onerror="this.src='{{URL::asset('assets/images/logo_icon.svg')}}'">
                    <span class="d-none d-sm-inline-block ms-3 text-white fw-semibold fs-6">UCAA</span>
                </a>
            </div>
            ...
            <ul class="nav flex-row justify-content-end order-1 order-lg-2">
                ...
                @else
                <li class="nav-item">
                    <a href="{{ route('login') }}" class="navbar-nav-link navbar-nav-link-icon rounded-pill">
                        <i class="ph-user-circle"></i>
                        <span class="d-none d-lg-inline-block ms-2">Login</span>
                    </a>
                </li>
                @endauth
            </ul>
