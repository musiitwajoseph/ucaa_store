        ...
        @if(@$user)
                    ...
                    @php
                        ...
                        foreach($user->team as $employee) {
                            ...
                            //         'status' => \App\Helpers\AppraisalDocumentStatus::workStatusInLineCss(@$appraisal->id),
                            ...
                            // }
                            // else
                            if ($appraisal && $appraisal->status == 1 && $appraisal->approval_work_plan_counter == 2 && $appraisal->approval_work_plan_status == 1) {
                                $pendingList[] = array(
                                    'name' => $employee->full_name ?? '',
                                    'status' => \App\Helpers\AppraisalDocumentStatus::workStatusInLineCss(@$appraisal->id),
                                    'date_submitted' => $appraisal->workplan_submission_date ? \Carbon\Carbon::parse($appraisal->workplan_submission_date)->format('d M Y, h:i:s A') : '',
                                    'code' => $appraisal->code ?? '',
                                    'link' => url('workplan/view/' . $appraisal->id),
                                );
                            }
                            ...
                            //     );
                            // }
                            // elseif ($appraisal && $appraisal->status == 1 && $appraisal->approval_final_counter == 4 && $appraisal->approval_final_status == 1) {
