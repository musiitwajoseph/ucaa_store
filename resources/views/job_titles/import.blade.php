...
<div class="content">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h4 class="mb-1">Import Job Titles</h4>
            <p class="text-muted mb-0">Upload Excel or CSV file to import multiple job titles</p>
        </div>
    ...
    <div class="row">
        ...
        <div class="col-lg-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('job-titles.import.process') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="d-flex justify-content-end gap-2">
                            <a href="{{ route('job-titles.index') }}" class="btn btn-light">Cancel</a>
                            <button type="submit" class="btn btn-primary">
                                <i class="ph-upload me-2"></i>Import Job Titles
                            </button>
                        </div>
                    </form>
                </div>
        ...
        <div class="col-lg-4">
            ...
            <div class="card mb-3">
                ...
                <div class="card-body">
                    <p>Download the template file to see the required format for importing job titles.</p>
                    <a href="{{ route('job-titles.template') }}" class="btn btn-success w-100">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <ul class="mb-3">
                        <li><strong>code</strong> - Unique job title code</li>
                        <li><strong>description</strong> - Job title description</li>
                        <li><strong>level</strong> - Job level (e.g., Junior, Mid, Senior)</li>
                    ...
                    <ul class="mb-0">
                        ...
                        <li>Leave is_active blank or set to 'true' for active titles</li>
                    </ul>
                </div>
            </div>
        </div>
