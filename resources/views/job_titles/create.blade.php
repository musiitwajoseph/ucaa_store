...
<div class="content">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h4 class="mb-1">Create Job Title</h4>
            <p class="text-muted mb-0">Add a new job title</p>
        </div>
        ...
        <div class="card-body">
            <form action="{{ route('job-titles.store') }}" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <div class="form-text">Leave blank for auto-generation (e.g., JOB0001)</div>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="level" class="form-control" value="{{ old('level') }}" placeholder="e.g., Senior, Junior, Manager">
                ...
                <div class="d-flex justify-content-end">
                    ...
                    <button type="submit" class="btn btn-primary ms-2">
                        <i class="ph-check me-1"></i> Create Job Title
                    </button>
                </div>
            </form>
        </div>
