...
<div class="content">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h4 class="mb-1">Job Titles</h4>
            <p class="text-muted mb-0">Manage job titles</p>
        </div>
        <div>
            <a href="{{ route('job-titles.import') }}" class="btn btn-success me-2">
                <i class="ph-upload me-2"></i>Import
            </a>
            <a href="{{ route('job-titles.create') }}" class="btn btn-primary">
                <i class="ph-plus me-2"></i>Add Job Title
            </a>
        </div>
    </div>
    @if(session('success'))
    ...
    <div class="card">
        <div class="card-header">
            <h5 class="mb-0">All Job Titles</h5>
        </div>

        <div class="card-body">
            <table class="table eagle-table2 table-hover" id="job-titles-table">
                <thead>
                    <tr>
                        <th>Code</th>
                        <th>Title</th>
