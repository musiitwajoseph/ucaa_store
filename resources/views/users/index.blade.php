...
<div class="content">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <div>
            @can('data-import')
            <a href="{{ route('users.import') }}" class="btn btn-success me-2">
    ...
    <div class="card">
        ...
        <div class="card-body">
            <table class="table eagle-table2 table-hover" id="users-table">
                <thead>
                    <tr>
                        <th>Code</th>
                        <th>Name</th>
    ...
    $(document).ready(function() {
        $('#users-table').DataTable({
            ...
            columns: [
                ...
                { data: 'job_title', name: 'jobTitle.title' },
                { data: 'office_location', name: 'officeLocation.name' },
