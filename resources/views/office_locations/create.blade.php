...
<div class="content">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h4 class="mb-1">Create Office Location</h4>
            <p class="text-muted mb-0">Add a new office location</p>
        </div>
            ...
            <form action="{{ route('office-locations.store') }}" method="POST">
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <div class="form-text">Leave blank for auto-generation (e.g., LOC0001)</div>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-3 mb-3">
                        ...
                        <input type="text" name="floor" class="form-control" value="{{ old('floor') }}" placeholder="e.g., 1st, 2nd">
                    </div>
                ...
                <div class="d-flex justify-content-end">
                    ...
                    <button type="submit" class="btn btn-primary ms-2">
                        <i class="ph-check me-1"></i> Create Location
                    </button>
                </div>
            </form>
        </div>
