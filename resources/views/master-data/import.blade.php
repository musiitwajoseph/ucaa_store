...
<div class="container-fluid">
    <div class="mb-4">
        <h1 class="h3 mb-0">Import Master Data</h1>
        <p class="text-muted">Upload a CSV file to import multiple master data items at once</p>
    </div>
    ...
    <div class="row">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('master-data.import.process') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                            ...
                            <div class="d-flex">
                                ...
                                <div>
                                    ...
                                    <ul class="mb-0">
                                        ...
                                        <li>Optional columns: <code>description</code>, <code>category_id</code>, <code>type</code>, <code>unit</code>, <code>value</code>, <code>metadata</code>, <code>display_order</code>, <code>is_active</code></li>
                                        <li>Use numeric category ID for <code>category_id</code></li>
                                        <li>Use <code>1</code> for active, <code>0</code> for inactive</li>
                                        <li>Metadata should be valid JSON string</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="d-flex justify-content-between">
                            ...
                            <button type="submit" class="btn btn-primary">
                                <i class="ph ph-upload me-2"></i>Import Master Data
                            </button>
                        </div>
                    </form>
                </div>
        ...
        <div class="col-md-4">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <a href="{{ route('master-data.template') }}" class="btn btn-success w-100">
            ...
            <div class="card mt-3">
                ...
                <div class="card-body">
                    <pre class="bg-light p-2 rounded small mb-0" style="font-size: 0.7rem;"><code>code,name,description,category_id,type,unit,value,metadata,display_order,is_active
LAPTOP_HP,HP Laptop,HP EliteBook,1,asset,pcs,1500.00,"{""brand"":""HP""}",0,1
DESKTOP_DELL,Dell Desktop,Dell OptiPlex,1,asset,pcs,1200.00,"{""brand"":""Dell""}",1,1</code></pre>
                </div>
            </div>
            ...
            <div class="card mt-3">
                ...
                <div class="card-body">
                    <ul class="small mb-0">
                        ...
                        <li>Use valid category IDs from the table above</li>
                        <li>Escape quotes in JSON metadata</li>
