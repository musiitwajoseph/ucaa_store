...
<div class="content">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h4 class="mb-1">Master Data</h4>
            <p class="text-muted mb-0">Manage system-wide master data items</p>
        </div>
        <div>
            @can('data-export')
            <a href="{{ route('master-data.template') }}" class="btn btn-success me-2">
                <i class="ph-download me-2"></i>Export Template
            </a>
            @endcan
            @can('data-import')
            <a href="{{ route('master-data.import') }}" class="btn btn-info me-2">
                <i class="ph-upload me-2"></i>Import
            </a>
            @endcan
            @can('master-data-create')
            <a href="{{ route('master-data.create') }}" class="btn btn-primary">
                <i class="ph-plus me-2"></i>Add Master Data
            </a>
            @endcan
        </div>
    </div>
    ...
    <div class="card">
        <div class="card-header">
            <h5 class="mb-0">All Master Data</h5>
        </div>

        <div class="card-body">
            <table class="table eagle-table2 table-hover" id="master-data-table">
                <thead>
                    <tr>
                        <th>Code</th>
                        <th>Name</th>
