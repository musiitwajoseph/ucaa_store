...
<div class="content">
    ...
    <div class="card">
        ...
        <div class="card-body">
            <table class="table eagle-table2 table-hover" id="roles-table">
                <thead>
                    <tr>
                        <th>Code</th>
                        <th>Name</th>
    ...
    $(document).ready(function() {
        $('#roles-table').DataTable({
            ...
            columns: [
                ...
                { data: 'permissions_count_display', name: 'permissions_count', searchable: false },
                { data: 'users_count_display', name: 'users_count', searchable: false },
